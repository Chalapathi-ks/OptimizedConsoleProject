...
public class downloadSampleCollectionsSearch extends uploadTest {

    @Page
    CollectionsActions collectionsActions;

    /**
     * Test to navigate to Collections page and download sample collections file
     */
    @Test(priority = 1, description = "Navigate to Collections page and download sample collections file")
    public void downloadSampleCollectionsFile() {
        System.out.println("=== Test: Download Sample Collections File ===");
        ...
        System.out.println("✓ Sample collections file download test completed successfully");
    }
} 