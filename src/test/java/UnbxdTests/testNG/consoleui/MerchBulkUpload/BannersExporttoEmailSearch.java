...
public class BannersExporttoEmailSearch extends uploadTest {
    ...
    @Test(description = "BANNERS BULK UPLOAD: Test banner bulk upload functionality with export to email", priority = 1, dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void promotionBulkUploadBannersTest(Object jsonObject) throws InterruptedException
    {
