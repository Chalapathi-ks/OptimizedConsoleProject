...
public class fieldRulesExporttoEmailBrowse extends uploadTest {
    ...
    @Test(description = "FIELD RULES BULK UPLOAD: Test field rules bulk upload functionality with export to email for browse page", priority = 1, dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void fieldRulesBulkUploadBrowseTest(Object jsonObject) throws InterruptedException
    {
