...
public class uploadPromotionsBulkSearch extends uploadTest {
    ...
    //Search test cases
    @Test(description = "BULK UPLOAD PROMOTIONS: Test bulk upload promotions functionality with file upload", priority = 1, groups = {"merchandising","sanity"})
    public void bulkUploadPromotionsUploadFile() throws InterruptedException
    {
        // Step 0: Find promotion file dynamically using common method
        String promotionFileName = findBulkUploadFile("promotion", "search");
        String directory = getBulkUploadDirectory("promotion");
        System.out.println("Search promotion bulk upload test using file: " + promotionFileName + " from " + directory);
        ...
        // Step 4: Select file from test data using the new method
