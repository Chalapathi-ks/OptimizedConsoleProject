...
public class promotiosExporttoEmailBrowse extends uploadTest {
    ...
    @Test(description = "BROWSE PROMOTIONS BULK UPLOAD: Test promotion bulk upload functionality with export to email", priority = 1, dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void promotionBulkUploadBrowseTest(Object jsonObject) throws InterruptedException
    {
