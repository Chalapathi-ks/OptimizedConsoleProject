...
public class downloadSampleBannersBrowse extends uploadTest {
    ...
    @Test(description = "BROWSE BULK UPLOAD BANNERS: Test bulk upload banners functionality with file download", priority = 1, dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void downloadSampleBannersBrowseTest(Object jsonObject) throws InterruptedException
    {
        ...
        // Step 1: Verify heading is displayed (same UI pattern as promotions)
        ...
        // Step 3: Click on bulk upload option (should work for banners too)
