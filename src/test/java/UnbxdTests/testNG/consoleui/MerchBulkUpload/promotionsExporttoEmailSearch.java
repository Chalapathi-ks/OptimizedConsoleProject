...
public class promotionsExporttoEmailSearch extends uploadTest {
    ...
    @Test(description = "PROMOTIONS BULK UPLOAD: Test promotion bulk upload functionality with export to email", priority = 1, dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void promotionBulkUploadTest(Object jsonObject) throws InterruptedException
    {
