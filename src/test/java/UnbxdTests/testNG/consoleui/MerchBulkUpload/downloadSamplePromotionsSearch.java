...
public class downloadSamplePromotionsSearch extends uploadTest {
    ...
    @Test(description = "BULK UPLOAD PROMOTIONS: Test bulk upload promotions functionality with file download", priority = 1, dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void downloadSamplePromotionsTest(Object jsonObject) throws InterruptedException
    {
