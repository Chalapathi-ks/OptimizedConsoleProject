...
public class downloadSampleFieldRuleSearch extends uploadTest {
    ...
    @Test(description = "BULK UPLOAD FIELD RULE: Test field rule bulk upload functionality with file download", priority = 1, dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void downloadSampleFieldRuleTest(Object jsonObject) throws InterruptedException
    {
