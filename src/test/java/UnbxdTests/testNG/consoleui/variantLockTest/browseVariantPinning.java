...
public class browseVariantPinning extends MerchVTest {
    ...
    @FileToTest(value = "/consoleTestData/variantPinning.json")
    @Test(description = "Browse: Creates, verifies and syncs the campaign creation with Variant Pinning for Browse Campaigns", dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void browseVariantPinningWithSyncTest(Object jsonObject) throws InterruptedException
    {
        JsonObject variantPinningJsonObject = (JsonObject) jsonObject;
        page = variantPinningJsonObject.get("query").getAsString()+System.currentTimeMillis();
    ...
    @FileToTest(value = "/consoleTestData/variantPinning.json")
    @Test(description = "Browse: Creates and verifies the campaign creation with Variant Pinning and Pending Sync for Browse Campaigns", dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void browseVariantPinningWithPendingSyncTest(Object jsonObject) throws InterruptedException
    {
        JsonObject variantPinningJsonObject = (JsonObject) jsonObject;
        page = variantPinningJsonObject.get("query").getAsString()+System.currentTimeMillis();
    ...
    @Test(description = "Browse: Creates and verifies the campaign creation with Variant Pinning, AB condition and Pending Sync for Browse Campaigns", dataProviderClass = ResourceLoader.class, dataProvider = "getTestDataFromFile", groups = {"merchandising","sanity"})
    public void browseVariantPinningABPendingSyncTest(Object jsonObject) throws InterruptedException
    {
        JsonObject ABData = (JsonObject) jsonObject;
        page = ABData.get("query").getAsString()+System.currentTimeMillis();
